...

{
  ...
  "children": [
    {
      "name": "Child Node 1",
      "explanation": "Explanation for child node 1.",
      "children": [
        {
          "name": "Grandchild Node 1.1",
          "explanation": "Explanation for grandchild node 1.1."
        },
        {
          "name": "Grandchild Node 1.2",
          "explanation": "Explanation for grandchild node 1.2."
        }
      ]
    },
    {
      "name": "Child Node 2",
      "explanation": "Explanation for child node 2.",
      "children": [
        {
          "name": "Grandchild Node 2.1",
          "explanation": "Explanation for grandchild node 2.1."
        }
      ]
    }
  ]
